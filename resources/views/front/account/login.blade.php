        ...
        <div class="container">
            ...
            <div class="login-form">
                <form action="{{ route('account.authenticate') }}" method="post">
                    ...
                    <input type="submit" class="btn btn-dark btn-block btn-lg rounded" value="Đăng nhập">
                </form>
                <div class="text-center small">Bạn chưa có tài khoản? <a href="{{ route('account.register') }}">Đăng ký tài
                        khoản</a></div>
            </div>
        </div>
    </section>
