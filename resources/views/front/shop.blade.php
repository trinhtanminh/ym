                                        ...
                                        <div class="accordion-item">
                                            ...
                                            @else
                                                <a href="{{ route('front.shop', $category->slug) }}"
                                                    class="nav-item nav-link {{ $categorySelecteds == $category->id ? 'text-primary' : '' }}">{{ $category->name }}</a>
                                            @endif
                                            @if ($category->sub_category->isNotEmpty())
                                                <div id="collapseOne-{{ $key }}"
                                                    class="accordion-collapse collapse {{ $categorySelecteds == $category->id ? 'show' : '' }}"
                                    ...
                                    <div class="card product-card">
                                        <div class="product-image position-relative">
                                            ...
                                            <div class="product-action">
                                                <a class="btn btn-outline-danger" href="javascript:void(0);" onclick="addToCart({{$product->id}});">
                                                    <i class="fa fa-shopping-cart"></i> THÊM VÀO GIỎI HÀNG
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body text-center mt-3">
                                            ...
                                            <div class="price mt-2">
                                                ...
                                                @if ($product->compare_price > 0)
                                                    <span
                                                        class="h6 text-underline"><del>{{ $product->compare_price }} đ</del></span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
